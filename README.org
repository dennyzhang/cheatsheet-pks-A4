...
- Related posts:  [[https://cheatsheet.dennyzhang.com/cheatsheet-bosh-A4][Bosh CheatSheet]], [[https://cheatsheet.dennyzhang.com/cheatsheet-openshift-A4][OpenShift CheatSheet]]
...
| [[https://github.com/cloudfoundry-incubator/cfcr-etcd-release][CFCR/Kubo]]                     | CFCR aims to deploy/manage fleets of k8s clusters.  [[https://github.com/cloudfoundry-incubator/kubo-release#option-2-three-masters][GitHub: kubo-release]], [[https://github.com/cloudfoundry-incubator/cfcr-etcd-release][cfcr-etcd-release]] |
...
* DONE Local notes                                                 :noexport:
  CLOSED: [2018-10-24 Wed 16:14]
** DONE Scenario: how airgap is implemented: iptable rules         :noexport:
   CLOSED: [2018-10-24 Wed 16:14]
 https://github.com/pivotal-cf/pks-releng-ci/blob/master/scripts/airgap_env.sh
 https://gitlab.eng.vmware.com/PKS/tooling/hack-nimbus/blob/master/pks-dev-with-nsx-t/gw/scripts/airgap/iptable.rules
...
** TODO "bosh vms" runs into certificate problem: not good in jumpbox, but good in ops manager vm
 ...
 Exit code 1
 #+END_EXAMPLE
* TODO Summarize the footprint                                     :noexport:
...
* TODO why create-deployment will do?                              :noexport:
#+BEGIN_EXAMPLE
