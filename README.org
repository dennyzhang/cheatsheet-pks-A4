...
| Name                          | Command                                                                  |
|-------------------------------+--------------------------------------------------------------------------|
| Computing virtualization      | [[https://docs.vmware.com/en/VMware-vSphere/index.html][VMware vSphere Documentation]]                                             |
...
| [[https://docs-cfcr.cfapps.io/][CFCR/Kubo]]                     | CFCR aims to deploy/manage fleets of k8s clusters. Kubo is the old name. |
...
* TODO pks scenario: once we have login to jumpbox, what command to run in order to run bosh commands? :noexport:
export http_proxy=http://10.160.201.176:80
* TODO pks scenario: once we have login to jumpbox, what command to run, in order to pks cluster command? :noexport:
...
** Scenario: How to run bosh command
** Scenario: How to run pks command
** Scenario: How to run kubectl command
** #  --8<-------------------------- separator ------------------------>8-- :noexport:
