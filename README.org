...
Related post: [[https://cheatsheet.dennyzhang.com/cheatsheet-bosh-A4][Bosh CheatSheet]], [[https://cheatsheet.dennyzhang.com/cheatsheet-tile-A4][Tile CheatSheet]]
** PKS Basic
| Name                             | Command                                                                                                  |
|----------------------------------+----------------------------------------------------------------------------------------------------------|
| YouTube: PKS overview            | [[https://www.youtube.com/watch?v=d_NuJ7skpuY&index=19&list=PL7bmigfV0EqQzsvOcT8KYfulg-lpNsooC][YouTube: Webcast - Deploy and Manage Enterprise Kubernetes with VMware Pivotal Container Service (PKS))]]  |
| YouTube: Series For PKS          | [[https://www.youtube.com/playlist?list=PL7bmigfV0EqQzsvOcT8KYfulg-lpNsooC][Pivotal Container Service (PKS) Demos and Webcasts]]                                                       |
| CFCR/Kubo                        | CFCR(Cloud Foundry Container Runtime) aims to deploy/manage fleets of k8s clusters. Kubo is the old name |
| Bosh, tile, ops manager          | [[https://cheatsheet.dennyzhang.com/cheatsheet-bosh-A4][link: BOSH CHEATSHEET]]                                                                                    |
...
| Reference                        | [[https://docs.pivotal.io/pivotalcf/2-3/customizing/troubleshooting-diagnostics.html][link: PKS Troubleshooting and Diagnostics]]                                                                |
...
| Bosh director vm                  |         |
| Ops manager vm                    |         |
| Build-in process in k8s master vm |         |
| Build-in process in k8s worker vm |         |
