...
- Related posts: [[https://cheatsheet.dennyzhang.com/cheatsheet-bosh-A4][Bosh CheatSheet]], [[https://cheatsheet.dennyzhang.com/cheatsheet-tile-A4][Tile CheatSheet]]
...
| Name                                              | Summary                                                                         |
|---------------------------------------------------+---------------------------------------------------------------------------------|
| How to run pks cli commands                       | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet-pks-A4/master/run-pks-cli.md][run-pks-cli.md]]                                                                  |
| How to run bosh cli commands                      | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet-pks-A4/master/run-bosh-cli.md][run-bosh-cli.md]]                                                             |
| How to run kubectl command                        | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet-pks-A4/master/run-kubectl.md][run-kubectl.md]]                                                    |
...
| PKS admin login to bosh for additional operations | Get bosh crediential from Ops Manager, ssh to opsmanager, and run bosh commands |
...
| Deployment for env without internet               | Enforce air-gapped deployments                                                  |
...
[[https://cheatsheet.dennyzhang.com/cheatsheet-pks-A4][https://raw.githubusercontent.com/dennyzhang/cheatsheet-pks-A4/master/pks-deployment.png]]
...
** jumpbox VM vs OpsManager VM
** #  --8<-------------------------- separator ------------------------>8-- :noexport:
** where I can find pks-api:8443?
https://docs.pivotal.io/runtimes/pks/1-2/manage-users.html#uaa-admin-login
** align with the official documents link
