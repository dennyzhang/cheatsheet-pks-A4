...
- PDF Link: [[https://github.com/dennyzhang/cheatsheet-pks-A4/blob/master/cheatsheet-pks-A4.pdf][cheatsheet-pks-A4.pdf]]
...
| Name                               | Command                                                                                         |
|------------------------------------+-------------------------------------------------------------------------------------------------|
| Crreate k8s cluster                | [[https://docs.pivotal.io/runtimes/pks/1-1/create-cluster.html][link: Create a Kubernetes Cluster]]                                                               |
