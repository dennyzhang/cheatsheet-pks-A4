...
| Name      | Command                                                                                     |
|-----------+---------------------------------------------------------------------------------------------|
| YouTube   | [[https://www.youtube.com/watch?v=d_NuJ7skpuY&index=19&list=PL7bmigfV0EqQzsvOcT8KYfulg-lpNsooC][YouTube: PKS overview]], [[https://www.youtube.com/playlist?list=PL7bmigfV0EqQzsvOcT8KYfulg-lpNsooC][YouTube: Pivotal Container Service (PKS) Demos and Webcasts]]          |
...
| [[https://docs-cfcr.cfapps.io/][CFCR/Kubo]]                     | CFCR aims to deploy/manage fleets of k8s clusters.  [[https://github.com/cloudfoundry-incubator/kubo-release#option-2-three-masters][GitHub: kubo-release]], [[https://github.com/cloudfoundry-incubator/cfcr-etcd-release][cfcr-etcd-release]] |
...
| Reference                                   | [[https://cheatsheet.dennyzhang.com/cheatsheet-tile-A4][CheatSheet: Cloudfoundry Tile & OpsManager]]                                                                             |
...
| Create cluster                 | =pks create-cluster cluster1 --external-hostname cluster1.pks.com --plan "plan 1" --num-nodes 1=   |
...
| pks login                      | =pks login --skip-ssl-validation --username <username> --password <password> --api <pks.test.com>= |
